...
namespace SNICKERS.Server.Controllers.School
{
    ...
    public class EnrollmentController : Controller
    {
        ...
        public async Task<IActionResult> PostEnrollment([FromBody] EnrollmentDTO _EnrollmentDTO)
        {
            try
            {
                ...
                Enrollment e = new Enrollment
                {
                    ...
                    FinalGrade = (byte?)_EnrollmentDTO.FinalGrade,
        ...
        public async Task<IActionResult> PutEnrollment(EnrollmentDTO _EnrollmentDTO)
        {
            ...
            {
                var trans = await _context.Database.BeginTransactionAsync();
                Enrollment e = await _context.Enrollments.Where(x => x.StudentId.Equals(_EnrollmentDTO.StudentId)).FirstOrDefaultAsync();
                ...
                if (e != null)
                {
                    ...
                    e.FinalGrade = (byte?)_EnrollmentDTO.FinalGrade;
        ...
        public async Task<IActionResult> DeleteEnrollment(int pStudentId)
        {
            ...
            try
            {
                ...
                var trans = await _context.Database.BeginTransactionAsync();
                Enrollment e = await _context.Enrollments.Where(x => x.StudentId.Equals(pStudentId)).FirstOrDefaultAsync();
